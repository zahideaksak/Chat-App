...
import com.zahideaksak.chatapp.R
import com.zahideaksak.chatapp.databinding.FragmentChatBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.sendBtn.setOnClickListener {
            auth.currentUser?.let {
                ...
                val date = FieldValue.serverTimestamp()  //guncel zamani aliyor

                val dataMap =
                    HashMap<String, Any>() //string-hangi anahtar kelime ile kaydettigim, any-deger tipleri
